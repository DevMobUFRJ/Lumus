...
const Faq = () => {
  ...
  const faqs = [
    {
      ...
      answer: `Informações que embalagens devem conter são regulamentadas no Brasil pelo INMETRO - Instituto Nacional de Metrologia, Qualidade e Tecnologia. Atualmente, as portarias emitidas por essa autarquia federal contemplam a obrigatoriedade dessas informações nas embalagens de lâmpadas e isso é seguido à risca pelos fabricantes.  No entanto, atenção! Nem todas as fontes de luz normalmente usadas nas residências são consideradas lâmpadas. É o caso dos painéis de LED. LED — Luz emitida por diodos — pode adquirir qualquer formato de bulbo, inclusive assumir a forma de uma luminária. Nesse caso, pode ser que o fabricante não te informe as propriedades, pois é comum a informação só ser dada quando obrigatória.
              O fabricante também pode omitir informação não obrigatória, quando ela não é relevante para o produto. O grau de abertura de lâmpadas difusas é um exemplo disso. Como não há risco de ofuscamento, a informação não é passada. Acontece, por vezes, em lâmpadas com grau igual ou superior a 1200.
  ...
  Sempre que possível, procure um profissional especializado em lighting design para lhe orientar na iluminação de sua residência, como designers de interiores, arquitetos ou engenheiros.`
    },
    {
      ...
      answer: `A luz geral de um ambiente é aquela luz que tem como objetivo iluminar uniformemente o cômodo, eliminando o máximo possível de sombras que venham a atrapalhar a realização de tarefas, com a quantidade de energia radiante (luz) ideal para o conforto lumínico do usuário. Essa quantidade ideal é determinada pelo nível de iluminância (lux), que é a relação entre o fluxo luminoso da lâmpada e a metragem quadrada do ambiente (l_m/m²). O nível de iluminância é regulamentado pela ABNT - Associação Brasileira de Normas Técnicas e deve levar em consideração a capacidade visual dos usuários (em termos gerais, segue a idade dos usuários) e a refletância das superfícies (capacidade de refletir a luz das paredes, piso e teto). 
  A luz geral não necessariamente deve estar vinculada à disposição dos mobiliários no cômodo (layout), visto que ela é uma luz para o ambiente. Sombras que a luz geral não conseguiu eliminar ou sombras criadas pelo posicionamento do usuário, em virtude da distribuição dos móveis, são eliminadas pela luz de destaque, que sim, tem relação com o layout do ambiente e, normalmente, é direcional, enquanto a luz geral é difusa. Isso deve ajudar você a identificar a luz geral do seu cômodo. 
  Lembre! Ela pode ser ofertada por um ou mais conjuntos de equipamentos (lâmpada e luminária), sempre distribuídos uniformemente. Por isso, quando é ofertada só por um conjunto de equipamento, ele fica localizado no centro do ambiente. 
  O Lumos ajuda você a saber quanto de fluxo luminoso cada lâmpada que você usa para a luz geral de cada cômodo deve ter, considerando a quantidade de pontos de luz do ambiente, assim como a quantidade de lâmpadas do conjunto de equipamentos utilizado em cada ponto.`
    },
    {

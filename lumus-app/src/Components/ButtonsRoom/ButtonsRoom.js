 ...
 const ButtonsRoom = ({colorRoom, colorKitchen, corBedroom}) => {
    ...
    return(
        ...
        <div id='DivReader'>
            ...
            <div id='buttons'>
            <button style={{ backgroundColor: colorRoom ? '#F8E6B7' : 'white' , border: colorRoom ? 'none': '2.6px solid #DBD7CE'}}> <Link to='/Sala' style={{textDecoration: 'none', color: "black"}}>Sala </Link></button>
